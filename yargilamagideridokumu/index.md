    ...
    <div class="card-body">
        ...
        <div class="col-12">
            <div class="form-group row">
                <label for="yargilamagideri" class="col-sm-4 col-form-label">{{ site.data.veriler.asgari.asliye.maktu }}</label>
                <input type="hidden" id="{{ site.assets.veriler[0].tebligatlar.teb18.adi }}" value="{{ site.veriler.asliye.maktu }}">
                <div class="col-sm-6">
