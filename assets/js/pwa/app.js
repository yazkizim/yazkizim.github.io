...
$.ajax({
	...
	success: function(data) {
		if (data['USD']['d_oran'] > 0) { 
			...
			$('#dolar').html("<br>" + parseFloat(data['USD']['satis']).toFixed(2) + ' ₺');
		...
		if (data['EUR']['d_oran'] > 0) { 
			...
			$('#euro').html("<br>" + parseFloat(data['EUR']['satis']).toFixed(2) + ' ₺');
		...
		if (data['GA']['d_oran'] > 0) { 
			...
			$('#altin').html("<br>" + parseFloat(data['GA']['satis']).toFixed(2) + ' ₺');
		...
		if (data['XU100']['degisim'] > 0) { 
			...
			$('#bist').html("<br>" + parseFloat(data['XU100']['satis']).toFixed(2) + ' ₺');
		...
		if (data['BTC']['d_oran'] > 0) { 
			...
			$('#btc').html("<br>" + parseFloat(data['BTC']['satis']).toFixed(2) + ' $');
