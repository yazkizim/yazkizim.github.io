...
if ($('#thhbilirkisiucret').length > 0) {
	...
	$.ajax({
		...
		for (i=0; i < json.length; i++)	{
			...
			window.dataTes.row.add([urun, katsayi, brut, damgav, gelirv, netode + ' TL']).draw(false);
