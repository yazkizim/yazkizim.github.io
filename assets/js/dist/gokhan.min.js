	...
	$("#enffarkhesapla").click(function() {
			...
			if (document.getElementById('1aye').disabled) {
				...
				if (document.getElementById('1aye').value * 1 > 0) {
					...
					toplamenfr = toplamenfr * (document.getElementById('1aye').value * 1);
			...
			if (document.getElementById('2aye').disabled) {
				...
				toplamenfr = toplamenfr * (document.getElementById('2aye').value * 1);
			} else {
			...
			if (document.getElementById('3aye').disabled) {
				...
				toplamenfr = toplamenfr * (document.getElementById('3aye').value * 1);
			} else {
			...
			if (document.getElementById('4aye').disabled) {
				...
				toplamenfr = toplamenfr * (document.getElementById('4aye').value * 1);
			} else {
			...
			if (document.getElementById('5aye').disabled) {
				...
				toplamenfr = toplamenfr * (document.getElementById('5aye').value * 1);
			} else {
			...
			if (document.getElementById('6aye').disabled) {
				...
				toplamenfr = toplamenfr * (document.getElementById('6aye').value * 1);
			} else {
