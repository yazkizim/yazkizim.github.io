	...
	$("#asgarihesapla").click(function() {
			...
			if (ay == hangiaydolacak) {				
				...
				if (ay < arazamay) { 
					...
					console.log('çalıştı 2 ' + gecisgvistisna + ' kumu ' + kumulatifmatrah);
					gecismatrah = parseFloat((kumulatifmatrah * 1) + (ikinciasgarinet * 1) - (basamak15 * 1)).toFixed(2) *1;
					gecisgvistisna += parseFloat(gecismatrah * 0.20).toFixed(2) * 1;
					document.getElementById('dv' + ay).value = parseFloat(ikinciasgariucret * 0.00759).toFixed(2);
				}
