...
$("#suryolhesapla").click(function() {
	...
	var kesintili;
	if (unvan == 1) {
		carpan = window.veriler[0].yolluk.mudur;
	} 
	
	

	if (parseInt(derece) == 203){
		carpan = window.veriler[0].yolluk.birden4dereceyekadar;
	} else if (parseInt(derece) == 200) {
		carpan = window.veriler[0].yolluk.besvesonrasi;
	}
...
!function() {
	...
	$("#etiketyazdir").click(function() {
		...
		w=window.open('https://adliyeci.com.tr/etiketbasim/sablon.html?etiketonek=' + etiketonek + '&etiketyil='+etiketyil+'&etiketno='+etiketno, target="_blank");						
	})
