            ...
            $.each(data, function(k, obj) {	
				if(obj['mahal'].toLowerCase() ==  adliye.toLowerCase()){
					...
					if(obj['durum'] == 'Faal') {
						...
						metinekle = adliyemetin + obj['mahal'] + ' adliyesi ' + obj['bolge'] + '. bölge (derece) adliyelerdendir.<br>';
					} else if (obj['durum'] == 'Birleştirildi') {
						metinekle = obj['mahal'] + ' (' + obj['il'] + ') adliyesi evvelce kapatılarak ' +  obj['bagli_adliye'] + ' adliyesi ile birleştirilmiştir.<br>';
					} else if (obj['durum'] == 'Faal Değil') {
						metinekle = obj['mahal'] + ' (' + obj['il'] + ') adliyesi evvelce kapatılmıştır, şuan ' +  obj['bagli_adliye'] + ' adliyesine bağlı bulunmaktadır.<br>';						
					} else if (obj['durum'] == 'Teşkilat Kurulmadı') {
						metinekle = obj['mahal'] + ' (' + obj['il'] + ') adliye hiç kurulmamıştır, şuan ' +  obj['bagli_adliye'] + ' adliyesine bağlı bulunmaktadır.<br>';						
					} 

					if (obj['teskilat'] == 'ACM'){
						metinekle = adliyemetin + obj['mahal'] + ' adliyesi Ağır Ceza merkezli adliyedir.<br>';
					} else {
						metinekle = adliyemetin + obj['mahal'] + ' adliyesi ' + obj['bagli_acm'] + ' adliyesinin mülhakat adliyesidir.<br>';
					}					
