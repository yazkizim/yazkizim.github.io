	...
	function harchesapla() {
		...
		if (davasonucu == '1') {
			...
			if (toplammasraf == 0) {
				...
				gidermetin = "- " + davacimetin + " tarafından yapılan; " + kesifharcimetin + bilirkisiucretimetin + tebligatmetin + " olmak üzere toplam " + (toplammasraf * 1).toFixed(2) + " TL'nin ";
				...
				gidermetin = gidermetin + " verilmesine, bakiye yargılama gideri olan " + (davaliyadusen * 1).toFixed(2) + " TL'nin " + davacimetin + " üzerinde bırakılmasına\n\n";
			}
