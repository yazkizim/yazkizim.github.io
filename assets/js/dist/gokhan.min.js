...
$("#emeklimaashesapla").click(function() {
		...
		brut_ikramiye = parseFloat(ikramiye_yili * parseFloat(((ozel_hizmet_tutar * 1) + (gosterge_ayligi_tutar * 1) + (ek_gosterge_ayligi_tutar * 1) + (taban_ayligi_tutar * 1) + (kidem_ayligi_tutar * 1) + (ekodemebrut7456*1) + (ek_odeme_tutar * 1).toFixed(2)))).toFixed(2);
