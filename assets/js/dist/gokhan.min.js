...
if ($('#adliyeid').length > 0) {
    ...
    let adliye = urlParams.get('adliye');
    ...
    $.getJSON("../assets/teskilat.json", function(data) {
            $.each(data, function(k, obj) {	
				if(obj['mahal'].toLowerCase() ==  adliye.toLowerCase()){
					$('#adliye').html('<br>' + adliye + " adliyesi nereye bağlı? " + adliye + " adliyesi var mı?<br>");  
					document.getElementById('adliye').innerHTML = '<br>' + adliye + " adliyesi nereye bağlı? " + adliye + " adliye var mı?<br>"; 
					if(obj['durum'] == 'Faal') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliye bulunmaktadır.<br>';
						adliyemetin = adliyemetin + obj['mahal'] + ' adliyesi ' + obj['bolge'] + '. bölge (derece) adliyelerdendir.<br>';
					} else if (obj['durum'] == 'Birleştirildi') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliyesi evvelce kapatılarak ' +  obj['bagli_adliye'] + ' adliyesi ile birleştirilmiştir.<br>';
					} else if (obj['durum'] == 'Faal Değil') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliyesi evvelce kapatılmıştır, şuan ' +  obj['bagli_adliye'] + ' adliyesine bağlı bulunmaktadır.<br>';						
					} else if (obj['durum'] == 'Teşkilat Kurulmadı') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliye hiç kurulmamıştır, şuan ' +  obj['bagli_adliye'] + ' adliyesine bağlı bulunmaktadır.<br>';						
					} 

					if (obj['teskilat'] == 'ACM'){
						adliyemetin = adliyemetin + obj['mahal'] + ' adliyesi Ağır Ceza merkezli adliyedir.<br>';
					} else {
						adliyemetin = adliyemetin + obj['mahal'] + ' adliyesi ' + obj['bagli_acm'] + ' adliyesinin mülhakat adliyesidir.<br>';
					}					
					
					adliyemetin = adliyemetin + obj['mahal'] + ' adliyesi ' + obj['bagli_bam'] + ' Bölge Adliye Mahkemesine bağlıdır.';
					$('#icerik').html(adliyemetin); 
					document.getElementById('icerik').innerHTML = adliyemetin;
					console.log('eşit');
				}	else {
					$('#adliye').html('<br>Bulunamadı<br>');     
					$('#icerik').html('');
				}			
            });
    }); 
