...
function yenimaashesapla() {
	...
	*/
	...
	var kidem_yili = $('input[name="hizmetyili"]').val();
	var ikramiye_yili = $('input[name="hizmetyili"]').val();
	var ek_odeme_tutar;
	var brut_ikramiye;
	var brut_maas;
	var net_ikramiye;
...
$("#suryolhesapla").click(function() {
	...
	var kesintili;
	if (unvan == 1) {
		carpan = site.data.yolluk.mudur;
	} 
	
	

	if (parseInt(derece) == 203){
		carpan = site.data.yolluk.birden4dereceyekadar;
	} else if (parseInt(derece) == 200) {
		carpan = site.data.yolluk.besvesonrasi;
	}
