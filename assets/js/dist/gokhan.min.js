...
if ($('#hatirlatmac').length > 0) {
	...
	for (var i = 0; i < 10; i++) {
		...
		if (i == 0) {
			html = html + '<div class="carousel-item active" style="background-color:' + renkler[i] + ';">';
		} else {
			html = html + '<div class="carousel-item" style="background-color:' + renkler[i] + ';">';
		}
...
$("#crgeri").click(function() {	
	$('#hatirlatmac').carousel('prev');
});

$("#crileri").click(function() {	
	$('#hatirlatmac').carousel('next');
});
