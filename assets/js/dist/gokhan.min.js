		...
		if (davasonucu == '1') {
			...
			if (toplammasraf == 0) {
                ...
                if (hesaplanacakgider *1 > 0) {
                    gidermetin = "- " + davacimetin + " tarafından yapılan; " + basvuruharcmetin + pesinharcmetin + tamamlamaharcmetin + islahharcimetin + " olmak üzere toplam " + hesaplanacakgider.toFixed(2) + " TL'nin";
                    if (davacibirdenfazla){
