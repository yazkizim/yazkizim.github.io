	...
	$("#asgarihesapla").click(function() {
			...
			while (ay < hangiaydolacak) {
				if (ay < arazamay) {
					...
					kumulatifmatrah += ikinciasgarinet;
					document.getElementById('vd' + ay).value = '15';
			...
			if (ay == hangiaydolacak) {
				if (ay < arazamay) { 
					gecismatrah += parseFloat((basamak15 * 1) - (kumulatifmatrah * 1)).toFixed(2);
					gecisgvistisna = parseFloat(gecismatrah * 0.15).toFixed(2);
				} else {
					kumulatifmatrah += ikinciasgarinet;
					gecismatrah += parseFloat((kumulatifmatrah * 1) - (basamak15 * 1)).toFixed(2);
					gecisgvistisna += parseFloat(gecismatrah * 0.20).toFixed(2);
				} 
				document.getElementById('vd' + ay).value = '20';
				document.getElementById('gv' + ay).value = parseFloat(gecisgvistisna).toFixed(2);
				document.getElementById('dv' + ay).value = parseFloat(ikinciasgariucret * 0.00759).toFixed(2);
				ay++;
			}
