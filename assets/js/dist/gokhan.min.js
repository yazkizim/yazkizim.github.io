	...
	function harchesapla() {
		...
		if (davasonucu == '1') {
			...
			if (toplammasraf == 0) {
				...
				gidermetin = "- " + davalimetin + " tarafından yapılan; " + kesifharcimetin + bilirkisiucretimetin + tebligatmetin + " olmak üzere toplam " + (toplammasraf * 1).toFixed(2) + " TL'nin ";
                ...
                console.log('a: ' + hesaplananacakgider);
				let davaciyadusen = (hesaplananacakgider * 1) * ((davamiktar * 1) - (kabulmiktar * 1) / (davamiktar * 1));
				let davaliyadusen = (hesaplananacakgider * 1) * ((kabulmiktar * 1) / (davamiktar * 1));
				gidermetin = gidermetin + (davaciyadusen * 1).toFixed(2) + " TL'nin " + davalimetinden + " alınarak ";
				if (davacibirdenfazla) {
					gidermetin = gidermetin + " davacılara ";
				} else {
					gidermetin = gidermetin + " davacıya ";
