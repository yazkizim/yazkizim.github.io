...
$('input[name="olumcismani"]').change(function() {
	...
	$("#avanshesapla").click(function() {		
		...
		var basvuruharci = window.giderler[0].basvuruharci;
		var dosyagideri = window.giderler[0].dosyagideri;
		var kesifharci = window.giderler[0].kesifharci;
		var hakimyolluk = window.giderler[0].hakimyolluk;
		var katipyolluk = window.giderler[0].katipyolluk;
		var musabiryolluk = window.giderler[0].musabiryolluk;
		var tanik = window.giderler[0].tanik;
		var tebligat = window.giderler[0].tebligat;
		var etebligat = window.giderler[0].etebligat;
		var vekaletharc = window.giderler[0].vekaletharc;
		var diger = window.giderler[0].diger;
