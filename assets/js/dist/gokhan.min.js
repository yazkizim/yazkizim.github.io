...
/*
  var $quiz = document.getElementById("quiz")
	...
	*/
	document.getElementById("quiz").setAttribute("class", "carousel slide");
	document.getElementById("quiz").setAttribute("data-ride", "carousel");

  // unique ID for container to refer to in carousel
 // var name = $quiz.setAttribute("id") || "urban_quiz_" + (++quiz_count);
 	document.getElementById("quiz").setAttribute("id", "urban_quiz_" + (++quiz_count));
  //$quiz.setAttribute('id', name);
  ...
  */
  $quiz_ekle = '#' + "urban_quiz_" + (++quiz_count);
  var $slides = $("<div>")
