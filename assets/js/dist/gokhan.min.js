    ...
    $.getJSON("../assets/teskilat.json", function(data) {
            $.each(data, function(k, obj) {	
				if(obj['mahal'].toLowerCase() ==  adliye.toLowerCase()){
					$('#adliye').html('<br>' + adliye + " adliyesi nereye bağlı? " + adliye + " adliye var mı?<br>");  
					document.getElementById('adliye').innerHTML = '<br>' + adliye + " adliyesi nereye bağlı? " + adliye + " adliye var mı?<br>"; 
					if(obj['durum'] == 'Faal') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliye bulunmaktadır.\n\n';
						adliyemetin = adliyemetin + obj['mahal'] + ' adliyesi ' + obj['bolge'] + '. bölge (derece) adliyelerdendir.\n\n'						
					} else if (obj['durum'] == 'Birleştirildi') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliyesi evvelce kapatılarak ' +  obj['bagli_adliye'] + ' adliyesi ile birleştirilmiştir.\n\n';
					} else if (obj['durum'] == 'Faal Değil') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliyesi evvelce kapatılmıştır, şuan ' +  obj['bagli_adliye'] + ' adliyesine bağlı bulunmaktadır.\n\n';						
					} else if (obj['durum'] == 'Teşkilat Kurulmadı') {
						adliyemetin = obj['mahal'] + ' (' + obj['il'] + ') adliye hiç kurulmamıştır, şuan ' +  obj['bagli_adliye'] + ' adliyesine bağlı bulunmaktadır.\n\n';						
					} 

					if (obj['teskilat'] == 'ACM'){
						adliyemetin = adliyemetin + obj['mahal'] + ' adliyesi Ağır Ceza merkezli adliyedir.\n\n';
					} else {
						adliyemetin = adliyemetin + obj['mahal'] + ' adliyesi ' + obj['bagli_acm'] + ' adliyesinin mülhakat adliyesidir.\n\n'
					}					
