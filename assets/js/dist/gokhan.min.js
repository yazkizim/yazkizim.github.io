...
function yenimaashesapla() {
	...
	*/
	...
	// gelir vergisi
	var gelir_vergisi = parseFloat(((gelir_vergisi_istisna * 1) - (((gosterge_ayligi_tutar * 1) + (ek_gosterge_ayligi_tutar * 1) + (taban_ayligi_tutar * 1) + (kidem_ayligi_tutar * 1) + (yan_odeme_tutar * 1) + (sendika_ikramiye_tutar * 1) - (sendika_kesinti_tutar * 1) + (fazla_mesai * 1)+ (tayin_tutar * 1)) * 15 / 100))).toFixed(2);
	if (gelir_vergisi * 1 > 0) {
		gelir_vergisi = 0.00;
	} else {
		gelir_vergisi = gelir_vergisi * -1;
