...
document.getElementById("atkgideri").addEventListener("keypress", function(event) {
  ...
  document.getElementById("bilirkisigideri").addEventListener("keypress", function(event) {
	...
	/*
  	for (var i = 1; el = document.getElementById("gteb" + i); i++) {
		console.log('eleman : ' + el);
		el.addEventListener("focus", myFocusFunction("gteb" + i), true);
		console.log('eleman : ' + "gteb" + i);
		el.addEventListener("blur", myBlurFunction("gteb" + i), true);
		function myFocusFunction(i) {
			document.getElementById(i).style.color = "red";  
			}
