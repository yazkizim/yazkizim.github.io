...
!function() {
	...
	function harchesapla() {
		...
		if (davasonucu == '1') {
			...
			toplammasraf = (kesifharci * 1) + (bilirkisiucreti * 1) + (tebligatmasraf * 1);
			if (toplammasraf == 0) {
				...
				let davaciyadusen = toplammasraf * ((davamiktar * 1) - (kabulmiktar * 1) / (davamiktar * 1));
				let davaliyadusen = toplammasraf * ((kabulmiktar * 1) / (davamiktar * 1));
