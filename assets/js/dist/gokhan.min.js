	...
	function harchesapla() {
		...
		if (davasonucu == '1') { // tam kabul davası
			...
			if (bakiyeharc == "0") {
				...
				harcmetin = "- Harçlar kanunu gereğince davadan feragat veya davayı kabul veya sulh, muhakemenin ilk celsesinden sonra vuku bulduğundan, maktu karar ve ilam harcının üçte ikisi olan toplam " + davadegeriuzerinden + (temelharc * 1).toFixed(2) + " TL ";
				harcmetin = harcmetin + " harcın mahsubu ile fazladan alınan " + (bakiyeharc * -1).toFixed(2) + " TL'nin yatıran tarafa iadesine,\n\n";
			}
			if (davalivekili) {
				vekaletnamemetin = "- " + davalimetin + " kendisini vekaletnameli vekil ile temsil ettirdiğinden karar tarihi itibariyle yürürlükte bulunan Avukatlık Asgari Ücret Tarifesi uyarınca hesaplanan "
		...
		if (davasonucu == '1') {
			...
			if (toplammasraf == 0) {
                ...
                let hesaplananacakgider = (((kesifharci * 1) + (bilirkisiucreti * 1) + (tebligatmasraf * 1))*1).toFixed(2);
                let hesaplanmayacakgider = ((basvuruharci *1) + (pesinharc *1)+ (tamamlamaharci *1) + (islahharci * 1)).toFixed(2);
                if (hesaplananacakgider *1 > 0) {
                    gidermetin = "- " + davacimetin + " tarafından yapılan; " + basvuruharcmetin + pesinharcmetin + tamamlamaharcmetin + islahharcimetin + " olmak üzere toplam " + hesaplananacakgider.toFixed(2) + " TL'nin";
                    if (davacibirdenfazla){
                ...
                if (davapara) {
                    davaliyadusen = (hesaplananacakgider * 1) * ((kabulmiktar * 1) / (davamiktar * 1));
				    davaciyadusen = ((hesaplananacakgider*1) - (davaliyadusen* 1)).toFixed(2);
                } else {
                    davaliyadusen = (hesaplananacakgider * 1) * 0.5;
				    davaciyadusen = ((hesaplananacakgider*1) - (davaliyadusen* 1)).toFixed(2);
                }                
